  ...
  function processRecord() {
    return {
      ...
      program: {
        ...
        client: { sandbox: true, start: true, service: false, title: null, header: null, surface: null, transaction: null, size: null, position: null, layer: null, minimize: null, maximize: null }
      },
      options: {},
